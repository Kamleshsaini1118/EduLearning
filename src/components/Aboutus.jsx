...
const Aboutus = () => {
  ...
  //         <h2 className="text-5xl font-semibold pt-2 pb-4">
  ...
  //           certain behavior, or improve their performance..
  //         </p>
  ...
  //     <div className="hidden md:flex md:w-full h-[150px] items-center justify-center px-4 -mt-4">
