  ...
  return (
    <div className="px-6 md:px-20 py-24">
      ...
      <p className="text-sm md:text-base text-gray-600">
        ...
        it, what we do to protect it, and to assist you in making informed
        decisions when using our website. Unless otherwise indicated below, this
        Privacy Policy applies to any website that references this Privacy
        Policy, any Company website, as well as any data the Company may collect
      ...
      <p className="text-sm md:text-base text-gray-600">
        ...
        which you connected to the website, the time and date of access, and
        other information that does not personally identify you. We use this
        information for, among other things, the operation of the website, to
        maintain the quality of the website, to provide general statistics
      ...
      <div className="mt-3 text-sm md:text-base text-gray-600">
        ...
        <li>
          <Link
            to="https://support.microsoft.com/en-us/windows/internet-explorer-downloads-d49e1f0d-571c-9a7b-d97e-be248806ca70"
            className="text-[#06bbcc] hover:text-[#2e828a]"
          >
            Internet Explorer
          </Link>
        </li>
        ...
        <li>
          <Link
            to="https://www.apple.com/in/safari/"
            className="text-[#06bbcc] hover:text-[#2e828a]"
          >
            Safari
          </Link>
      ...
      <p className="text-sm md:text-base text-gray-600">
        ...
        stored through InMotion Hosting servers. By using the website, you
